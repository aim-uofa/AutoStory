                ...
                if save_img:
                    if self.opt['is_train']:
                        ...
                        if self.opt['val']['suffix']:
                            save_img_path = osp.join(self.opt['path']['visualization'], prompt,
                                                     f'{img_name}---{self.opt["val"]["suffix"]}.png')
                        else:
                            save_img_path = osp.join(self.opt['path']['visualization'], f'iters_{current_iter}',
                                                     prompt, f'{img_name}---{current_iter}.png')
